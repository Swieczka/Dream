    ...
    void SpawnDungeon()
    {
      ...
      //  Debug.Log("X: " + randomX + " Y: " + randomY + " Rooms: " + MaxnumberOfRooms); 
        ...
        for (int i = 0; i < randomX; i++)
        {
            ...
            {
                GameObject SpawnedRoom = Instantiate(Room, new Vector3(gameObject.transform.position.x + i * 26, gameObject.transform.position.y + j * 16, gameObject.transform.position.z), Quaternion.identity,transform);
